...
def main():
    ...
    seed = 42
    output_file_name = "analysis_results_all.csv"
    
    # set input location
    base_directory_path = "C:/Users/Chris/Dropbox/Uni/MSc AI/11 IRP/Code/Phase 2 Model Training/test_results"
    ...
    print(f"{output_file_name} written to file")
