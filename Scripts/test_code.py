...
def write_outputs(per_instance_rows, mean_rmse_unmitigated, mean_rmse_mitigated, fraction, model):
    ...
    output_path = f"../Data/test_results/test_results_{int(fraction*100)}{model}.csv"
...
def main(fraction, model):
    ...
    unmitigated_file_path = "../Data/test_data/test_data_raw.csv"
    mitigated_file_path = f"../Data/mitigated_results/test_data_mitigated_{int(fraction*100)}{model}.csv"
