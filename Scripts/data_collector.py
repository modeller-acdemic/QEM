...
def main():
    ...
    # add the account details (removed for privacy reasons) for all the proportions greater than 0
    if fraction > 0.0:
    ...
    circuits_df = pd.read_csv('../Data/training_data/circuits/training_circuits.csv')
    ...
    results_df.to_csv(f'../Data/training_data/feature_engineered/engineered_results_{int(fraction*100)}.csv', index=False)
    print(f"Saved simulation results to /Data/training_data/feature_engineered/engineered_results_{int(fraction*100)}.csv")
    ...
    raw_df.to_csv(f'../Data/training_data/raw_data/raw_outputs_{int(fraction*100)}.csv', index=False)
    print(f"Saved raw outputs to /Data/training_data/raw_data/raw_outputs_{int(fraction*100)}.csv")
    ...
    plt.tight_layout()
    plt.savefig(f'../Data/training_data/verification_figs/non_param_gate_distribution_{int(fraction*100)}.png', dpi=300)
    print(f"\nSaved non-parameterised gate distribution plot to /Data/training_data/verification_figs/non_param_gate_distribution_{int(fraction*100)}.png")
    ...
    plt.xticks(rotation=90)
    plt.tight_layout()
    plt.savefig(f'../Data/training_data/verification_figs/param_gate_distribution_{int(fraction*100)}.png', dpi=300)
    print(f"\nSaved parameterised gate distribution plot to /Data/training_data/verification_figs/param_gate_distribution_{int(fraction*100)}.png")
